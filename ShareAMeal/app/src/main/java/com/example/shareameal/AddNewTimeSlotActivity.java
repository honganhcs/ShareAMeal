...
public class AddNewTimeSlotActivity extends AppCompatActivity {
    ...
    public void onBtnCreateSlotClick(View view) {
        ...
        if(date.equals("MMM DD YYY") || startTime.equals("HH:MM") || endTime.equals("HH:MM")) {
            ...
            Toast.makeText(AddNewTimeSlotActivity.this, "Please select a date after today.", Toast.LENGTH_SHORT).show();
        } else if(endHour < startHour || (endHour == startHour && endMinute <= startMinute)) {
            Toast.makeText(AddNewTimeSlotActivity.this, "End time must be after start time.", Toast.LENGTH_SHORT).show();
        } else {

            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Slots").child(userId);
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                    Toast.makeText(AddNewTimeSlotActivity.this, "Time slot successfully added.", Toast.LENGTH_SHORT).show();
                ...
                public void onCancelled(@NonNull @NotNull DatabaseError error) {
                    Toast.makeText(AddNewTimeSlotActivity.this, "Time slot failed to be added.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
