...
public class RecipientsRecords extends AppCompatActivity implements RVOrdersAdapter.OnOrderClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Orders").child("Completed").child(userId);
                ...
                new BottomNavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        if (curr == R.id.claimFood) {
                            Intent intent = new Intent(RecipientsRecords.this, RVDonors.class);
                            startActivity(intent);
                            finish();
                        } else if (curr == R.id.home) {
                            Intent intent = new Intent(RecipientsRecords.this, RecipientHomepageActivity.class);
                            startActivity(intent);
                            finish();
